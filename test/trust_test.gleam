...
pub fn bool_with_message_test() {
  True
  |> dynamic.from
  |> trust.bool_with_message("Custom message")
...
pub fn bool_literal_with_message_test() {
  True
  |> dynamic.from
  |> trust.bool_literal_with_message(True, "Custom message")
  |> should.equal(Ok(True))
...
pub fn string_with_message_test() {
  ""
  |> dynamic.from
  |> trust.string_with_message("Custom message")
  |> should.equal(Ok(""))
...
pub fn string_literal_with_message_test() {
  "A"
  |> dynamic.from
  |> trust.string_literal_with_message("A", "Custom message")
  |> should.equal(Ok("A"))
...
pub fn string_map_enum_with_message_test() {
  ...
  |> {
    trust.string
    |> trust.string_enum_with_message([#("A", 0), #("B", 1)], "Custom message")
  }
  |> should.equal(Ok(0))
